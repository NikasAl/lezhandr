                ...
                children: [
                  ...
                  _buildSection(
                    ...
                    content: 'Настоящая Политика конфиденциальности (далее — «Политика») определяет порядок обработки и защиты персональных данных пользователей мобильного приложения «Лежандр» (далее — «Приложение»). '
                        'Оператором персональных данных является Авдонин Никита Сергеевич (самозанятый) ИНН: 645390282599. Использование Приложения означает безоговорочное согласие Пользователя с настоящей Политикой.',
                  ),
                  ...
                  _buildSectionWithTable(
                    ...
                    intro: 'Приложение «Лежандр» — это мобильный клиент системы MindVector, предназначенный для отслеживания прогресса решения математических, физических и других учебных задач с использованием искусственного интеллекта. Приложение предоставляет следующие функции:',
                    tableRows: [
                      ...
                      ['AI-ассистент', 'Получение подсказок и наводящих вопросов и ответов на вопросы от искусственного интеллекта'],
                      ['Геймификация', 'Система XP, стриков для мотивации обучения'],
                      ['Карта навыков', 'Отслеживание освоенных концепций и навыков решения задач'],
                    ],
                  ),
                  ...
                  _buildDataTable(
                    ...
                    rows: [
                      ...
                      ['Фотографии условий', 'Фото задачи из учебника', 'Распознавание текста (OCR)'],
                      ['Текстовые решения задач', '«Решите уравнение...»', 'Хранение и анализ'],
                      ['Фотографии решений', 'Фото рукописи решения задачи', 'Распознавание текста (OCR), выявление примененных пользователем навыков для формирования обучающей траектории (Персонализация обучения)'],
                      ['Записи озарений и вопросов', 'Текстовые заметки', 'История обучения и помощь пользователю AI ассистентом'],
                      ['Фотографии приложений к вопросам, озарениям и советам', 'Фото рукописной заметки или черновика', 'Распознавание текста (OCR) для AI анализа вопросов и помощи пользователю с его затруднениями при решении задач'],
                      ['Время сессий решения', '15 минут, 1 час', 'Статистика и стрики'],
                      ['Логин', '@ganesha', 'Анонимная идентификация пользователя в системе'],
                      ['e-mail / пароль', 'ganesha@mail.ru / xxx', 'Опциональная возможность для входа пользователя в тот же аккаунт с другого устройства'],
                    ],
                  ),
                  ...
                  _buildDataTable(
                    ...
                    rows: [
                      ['Уникальный идентификатор аккаунта', 'Аутентификация и привязка данных к аккаунту пользователя'],
                  ...
                  _buildSectionWithTable(
                    ...
                    tableRows: [
                      ['Камера', 'Фотографирование условий задач из учебников и пособий', 'А также письменных решений задач для преобразования в текст, анализа - выявления примененных навыков решения задач и помощи в обучении'],
  ...
  Widget _buildContactInfo(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildContactRow(context, 'Оператор:', 'Авдонин Никита Сергеевич'),
          const SizedBox(height: 8),
